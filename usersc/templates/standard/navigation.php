...
if ($navstyle == 'Default') {
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <a href="<?= $us_url_root ?>users/appDashboard.php" style="text-decoration: none;"><img src="<?= $us_url_root ?>users/appImages/logo0.png" height="50px"> </a>
    ...
    <body>
      ...
      <div class="" style="background-color: #023c73;">
        <div class="text-center">
          <a style="left:-35px;position: relative;" href="<?= $us_url_root ?>"><img style="" src="<?= $us_url_root ?>users/appImages/logo0.png"></a>
        </div>
      </div>
    <?php }
    if ($settings->navigation_type == 1) {
  ...
  <?php } elseif ($navstyle == 'Right Side') {
    if ($settings->navigation_type == 0) {
      ...
      <body>
        ...
        <div class="" style="background-color: #023c73;">
          <div class="text-center">
            <a style="right:-35px;position: relative;" href="<?= $us_url_root ?>"><img style="" src="<?= $us_url_root ?>users/appImages/logo0.png"></a>
          </div>
        </div>
      <?php }
      if ($settings->navigation_type == 1) {
