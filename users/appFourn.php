...
<div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card border border-primary">    <!-- Card debut  -->
                ...
                <div class="card-header bg-primary text-white h6">NOUVEAU FOURNISSEUR</div>
                ...
                <div class="card-body table-responsive">
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <input class="form-control form-control-sm" type="text" name="nom" id="nom" placeholder="Nom ou Code fournisseur">
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <input class="form-control form-control-sm" type="number" name="contact" id="contact" size="20" minlength="10" maxlength="15" placeholder="Contact du fournisseur">
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <div class="input-group-prepend"> <span class="input-group-text">Addresse</span> </div>

                        <input class="form-control form-control-sm" type="text" name="adress" id="adress" placeholder="Addresse du fournisseur">
        ...
        <div class="col-md-8 mb-3">
            ...
            <div class="card border border-dark">    <!-- Card debut  -->
                ...
                <div class="card-header bg-dark text-white h6">LISTE DES FOURNISSEURS</div>
...
$(document).ready(function () {
    ...
    $("#insert").click(function() {
        ...
        dataToSend.append('contact', $("#contact").val());

        dataToSend.append('adress', $("#adress").val());
        ...
        $.ajax({
          ...
          url: "<?=$us_url_root?>users/api/fournReq",
	...
	$('#tab').DataTable({
		    ...
		    "ajax":{
				...
				url : "<?=$us_url_root?>users/api/fournReq", // json datasource
