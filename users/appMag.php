...
<div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card border border-primary">    <!-- Card debut  -->
                ...
                <div class="card-header bg-primary text-white h6">NOUVEAU MAGAZIN</div>
                ...
                <div class="card-body table-responsive">
                   ...
                   <!--  <div class="input-group mb-3 input-group-sm">
                        ...
                        <div class="input-group-prepend"> <span class="input-group-text">Date de la vente</span> </div>
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <div class="input-group-prepend"> <span class="input-group-text">Identifiant</span> </div>

                        <input class="form-control form-control-sm" type="text" name="nom" id="nom" placeholder="Nom ou code magasin">
...
?>
        ...
        <div class="col-md-8 mb-3">
            ...
            <div class="card border border-dark">    <!-- Card debut  -->
                ...
                <div class="card-header bg-dark text-white h6">LISTE DES MAGASIN</div>
...
$(document).ready(function () {
    ...
    $("#insert").click(function() {
        ...
        $.ajax({
          ...
          url: "<?=$us_url_root?>users/api/magReq",
	...
	$('#tab').DataTable({
		    ...
		    "ajax":{
				...
				url : "<?=$us_url_root?>users/api/magReq", // json datasource
