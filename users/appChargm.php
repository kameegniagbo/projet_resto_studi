...
<div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card border border-primary">    <!-- Card debut  -->
                ...
                <div class="card-header bg-primary text-white h6">NOUVEAU CHARGEMENT</div>
...
$query = $db->query("SELECT id FROM appCatOeuf");
...
?>
                            ...
                            <div class="input-group mb-3 input-group-sm">
                                ...
                                <input class="form-control form-control-sm" type="number" name="<?php echo $record["id"]; ?>" id="<?php echo $record["id"]; ?>" placeholder="Quantité <?php echo $record["id"]; ?>">
                            </div>
...
?>
        ...
        <div class="col-md-8 mb-3">
            ...
            <div class="card border border-dark">    <!-- Card debut  -->
                ...
                <div class="card-header bg-dark text-white h6">ETAT DE CHARGEMENT PAR CATEGORIE </div>
...
$(document).ready(function () {
    ...
    $("#insert").click(function() {
        ...
        $.ajax({
          ...
          url: "<?=$us_url_root?>users/api/chargmReq",
	...
	$('#tab').DataTable({
		    ...
		    "ajax":{
				...
				url : "<?=$us_url_root?>users/api/chargmReq", // json datasource
