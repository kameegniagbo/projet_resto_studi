...
function addData()
{
    ...
    $contact = checkEmptyInput($_POST["contact"]);
    $adress = checkEmptyInput($_POST["adress"]);
    ...
    $datehr = $dateTimeNow;
        ...
        // else
        // {
              $query0 = "INSERT INTO ".$table0." (nom, contact, adress, note, datehr) 
                        VALUES('".$nom."', '".$contact."', '".$adress."', '".$note."', '".$datehr."') ";
