...
function getAllData()
{
	...
	if( !empty($params['search']['value']) ) {   
		$where .=" WHERE 1 AND ";
		$where .=" ( nomCatOeuf LIKE '%".$params['search']['value']."%' )";
	}
...
function addData()
{
    ...
    $nomMag = checkEmptyInput($_POST["nomMag"]);
    ...
    $datehr = $dateTimeNow;
        ...
        // else
        // {
              $query0 = "INSERT INTO ".$table0." (date, nomCatOeuf, qte, nomRespo, nomLot, nomSal, nomBat, nomMag, note, datehr) 
                        VALUES('".$date."', '".$nomCatOeuf."', '".$qte."', '".$nomRespo."', '".$nomLot."', '".$nomSal."', '".$nomBat."', '".$nomMag."', '".$note."', '".$datehr."') ";
