...
function addData()
{
    ...
    $typOpera = checkEmptyInput($_POST["typOpera"]);
    $date = checkEmptyInput($_POST["date"]);
    $nomLot = checkEmptyInput($_POST["nomLot"]);
    $qtePoul = checkEmptyInput($_POST["qtePoul"]);
    $typPoul = checkEmptyInput($_POST["typPoul"]);
    $nomSal = checkEmptyInput($_POST["nomSal"]);
    ...
    $datehr = $dateTimeNow;
        ...
        // else
        // {
              $query0 = "INSERT INTO ".$table0." (typOpera, date, nomLot, qtePoul, typPoul, nomSal, nomBat, note, datehr) 
                        VALUES('".$typOpera."', '".$date."', '".$nomLot."', '".$qtePoul."', '".$typPoul."', '".$nomSal."', '".$nomBat."', '".$note."', '".$datehr."') ";
