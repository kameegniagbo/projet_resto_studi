...
function addData()
{
    ...
    $contactAdress = checkEmptyInput($_POST["contactAdress"]);
    $lieuAchatFav = checkEmptyInput($_POST["lieuAchatFav"]);
    ...
    $datehr = $dateTimeNow;
        ...
        // else
        // {
              $query0 = "INSERT INTO ".$table0." (nom, contactAdress, lieuAchatFav, note, datehr) 
                        VALUES('".$nom."', '".$contactAdress."', '".$lieuAchatFav."', '".$note."', '".$datehr."') ";
