...
function getAllData()
{
	...
	if( !empty($params['search']['value']) ) {   
		...
		$where .=" OR attribTach LIKE '%".$params['search']['value']."%' ";
		$where .=" OR natio LIKE '%".$params['search']['value']."%' ";
...
function addData()
{
    ...
    $dateNaiss = checkEmptyInput($_POST["dateNaiss"]);
    $sexe = checkEmptyInput($_POST["sexe"]);
    $natio = inputSanitize($_POST["natio"]);
    $situaMatri = checkEmptyInput($_POST["situaMatri"]);
    $attribTach = inputSanitize($_POST["attribTach"]);
    $photo = NULL;
    ...
    $datehr = $dateTimeNow;
        ...
        // else
        // {
              $query0 = "INSERT INTO ".$table0." (nom, dateNaiss, sexe, natio, situaMatri, attribTach, photo, note, datehr) 
                        VALUES('".$nom."', '".$dateNaiss."', '".$sexe."', '".$natio."', '".$situaMatri."', '".$attribTach."', '".$photo."', '".$note."', '".$datehr."') ";
