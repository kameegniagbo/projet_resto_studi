...
function addData()
{
    ...
    $nomFourn = checkEmptyInput($_POST["nomFourn"]);
    $nomReprez = checkEmptyInput($_POST["nomReprez"]);
    $produit = checkEmptyInput($_POST["produit"]);
    $qteProduit = checkEmptyInput($_POST["qteProduit"]);
    $nomMagDest = checkEmptyInput($_POST["nomMagDest"]);
    ...
    $datehr = $dateTimeNow;
        ...
        // else
        // {
              $query0 = "INSERT INTO ".$table0." (date, nomFourn, nomReprez, produit, qteProduit, nomMagDest, numFact, lieu, note, datehr) 
                        VALUES('".$date."', '".$nomFourn."', '".$nomReprez."', '".$produit."', '".$qteProduit."', '".$nomMagDest."', '".$numFact."', '".$lieu."', '".$note."', '".$datehr."') ";
