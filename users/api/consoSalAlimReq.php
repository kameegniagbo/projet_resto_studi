...
function addData()
{
    ...
    $nomAlim = checkEmptyInput($_POST["nomAlim"]);
    $qteAlim = checkEmptyInput($_POST["qteAlim"]);
    ...
    $datehr = $dateTimeNow;
        ...
        // else
        // {
              $query0 = "INSERT INTO ".$table0." (date, nomAlim, qteAlim, nomSal, nomBat, datehr) 
                        VALUES('".$date."', '".$nomAlim."', '".$qteAlim."', '".$nomSal."', '".$nomBat."', '".$datehr."') ";
