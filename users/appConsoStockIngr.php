...
<div class="row">
	...
	<div class="col-md-12">
	    ...
	    <h3 >DÉSTOCKAGE D'INGRÉDIENTS</h3>
...
<div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card border border-primary">    <!-- Card debut  -->
                ...
                <div class="card-header bg-primary text-white h6">NOUVEL ENRÉGISTREMENT</div>
                ...
                <div class="card-body table-responsive">
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <select class="form-control form-control-sm" name="nomAlim" id="nomAlim">
                            ...
                            <option value="Son_de_maïs">Son_de_maïs</option>
                            <option value="Son_cubé">Son_cubé</option>
                            <option value="Concentré">Concentré</option>
                            <option value="Soja_graine">Soja_graine</option>
                            <option value="Tourteau_de_soja">Tourteau_de_soja</option>
                            <option value="Blé_cassé">Blé_cassé</option>
                            <option value="Drèche">Drèche</option>
                            <option value="Coton">Coton</option>
                            <option value="Leucena">Leucena</option>
                            <option value="Coquille">Coquille</option>
                            <option value="Poisson">Poisson</option>
                            <option value="Premix">Premix</option>
                            <option value="Sulfate_de_fer">Sulfate_de_fer</option>
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <input class="form-control form-control-sm" type="number" name="qteAlim" id="qteAlim" placeholder="Quantité de l'aliment">
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <div class="input-group-prepend"> <span class="input-group-text">Magasin</span> </div>
...
?>
        ...
        <div class="col-md-8 mb-3">
            ...
            <div class="card border border-dark">    <!-- Card debut  -->
                ...
                <div class="card-header bg-dark text-white h6">RÉGISTRE DE DÉSTOCKAGE D'INGRÉDIENTS</div>
...
$(document).ready(function () {
    ...
    $("#insert").click(function() {
        ...
        $.ajax({
          ...
          url: "<?=$us_url_root?>users/api/consoStockIngrReq",
	...
	$('#tab').DataTable({
		    ...
		    "ajax":{
				...
				url : "<?=$us_url_root?>users/api/consoStockIngrReq", // json datasource
