...
<div class="row">
	...
	<div class="col-md-12">
	    ...
	    <h3 >GESTION DE LA PRODUCTION </h3>
...
<!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <div class="input-group-prepend"> <span class="input-group-text">Categorie </span> </div>

                        <select class="form-control form-control-sm" name="nomCatOeuf" id="nomCatOeuf" >
...
$query = $db->query("SELECT nom FROM appCatOeuf");
...
<!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <input class="form-control form-control-sm" type="number" name="qte" id="qte" placeholder="Quantite">
...
<!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <select class="form-control form-control-sm" name="nomSal" id="nomSal" onchange="loadSalDetails();">
...
<!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <select class="form-control form-control-sm" name="nomRespo" id="nomRespo" >

                            <option>Selectionnez un nom</option>
...
$query = $db->query("SELECT nom FROM appEmploy");
...
<!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <select class="form-control form-control-sm" name="nomLot" id="nomLot" >

                            <option>Selectionnez un lot</option>
...
$query = $db->query("SELECT nomLot FROM appPoul");
...
?>
        ...
        <option value="<?php echo $record["nomLot"]; ?>"><?php echo $record["nomLot"]; ?></option>
...
<!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <div class="input-group-prepend"> <span class="input-group-text">Magasin Stockage</span> </div>

                        <select class="form-control form-control-sm" name="nomMag" id="nomMag" >

                            <option>Selectionnez un magasin</option>
...
<!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
        ...
        <div class="col-md-8 mb-3">
            ...
            <div class="card border border-dark">    <!-- Card debut  -->
                ...
                <div class="card-header bg-dark text-white h6">REGISTRE DE PRODUCTION</div>
...
$(document).ready(function () {
    ...
    $("#insert").click(function() {
        ...
        dataToSend.append('nomCatOeuf', $("#nomCatOeuf").val());

        dataToSend.append('qte', $("#qte").val());

        dataToSend.append('nomRespo', $("#nomRespo").val());
        ...
        dataToSend.append('nomMag', $("#nomMag").val());
        ...
        $.ajax({
          ...
          url: "<?=$us_url_root?>users/api/prodReq",
	...
	$('#tab').DataTable({
		    ...
		    "ajax":{
				...
				url : "<?=$us_url_root?>users/api/prodReq", // json datasource
...
function loadSalDetails()
{
    console.log('loadSalDetails');
}
