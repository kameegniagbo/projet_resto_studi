...
<div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card border border-primary">    <!-- Card debut  -->
                <div class="card-header bg-primary text-white h6">NOUVELLE SALLE</div>
                <div class="card-body table-responsive">
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <input class="form-control form-control-sm" type="text" name="nom" id="nom" placeholder="Nom ou Code salle">
                    </div>
...
?>
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        <div class="input-group-prepend"> <span class="input-group-text">Respo.</span> </div>
...
?>
        ...
        <div class="col-md-8 mb-3">
            <div class="card border border-dark">    <!-- Card debut  -->
                <div class="card-header bg-dark text-white h6">LISTE DES SALLES</div>
                <div class="card-body table-responsive">
...
$(document).ready(function () {
    ...
    $("#insert").click(function() {
        ...
        $.ajax({
          type: 'POST',
          url: "<?=$us_url_root?>users/api/salReq",
          data: dataToSend,
          //cache: false,
          datatype: 'json',
	...
	$('#tab').DataTable({
		    ...
		    "serverSide": true,
		    "ajax":{
				url : "<?=$us_url_root?>users/api/salReq", // json datasource
				data : postData,
