                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>À Propos</h6>
                            <h2>Vivez une belle experience</h2>
                        </div>
                        <p>Popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. <br><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-heading">
                        <h6>Notre Menu</h6>
                        <h2>Notre selection de plats</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class='card card1'>
                            ...
                            <div class='info'>
                              ...
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Réservez <i class="fa fa-angle-down"></i></a></div>
                              </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        <div class="section-heading">
                            ...
                            <h2>Ici, vous pouvez faire une réservation ou simplement vous rendre à notre café.</h2>
                        </div>
                    ...
                    <div class="contact-form">
                        <form id="contact" action="" method="post">
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="phone" type="text" id="phone" placeholder="Numero de telephone*" required="">
                              </fieldset>
                            </div>
